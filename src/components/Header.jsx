            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center py-4">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        <a href="#home" className="hover:text-blue-400 transition-colors focus-ring rounded px-2 py-1">Home</a>
                        <a href="#projects" className="hover:text-blue-400 transition-colors focus-ring rounded px-2 py-1">Projects</a>
                ...
                {isMenuOpen && (
                    <nav className="md:hidden py-4 border-t border-gray-700">
                        <div className="flex flex-col space-y-4">
                            <a href="#home" onClick={closeMenu} className="hover:text-blue-400 transition-colors focus-ring rounded px-2 py-1">Home</a>
